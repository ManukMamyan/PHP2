...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Фев 18 2019 г., 15:44
...
(7, 'Roman', 'qwerty@mail.ru', 'Super!', '2017-10-28 12:44:53'),
(8, 'Roman', 'erer@mail.ru', '111111', '2017-10-28 12:46:34'),
(9, '11', '222@mail.ru', '333', '2017-10-28 15:49:03');
...
(3, 'Ноутбук Lenovo IdeaPad 110-15IBR (80T700С2RK)', 'Устройство справится с любыми профессиональными, бытовыми и учебными задачами, включая просмотр качественного видео и работу с офисными приложениями. Оно снабжено современным процессором Intel и оперативной памятью с большим объёмом.', 18990, 'uploads/item1.jpg', 'uploads/mini/item1.jpg', 1),
(5, 'Ноутбук HP 15-bs516ur 2GF21EA', 'Встроенный адаптер Wi-Fi a/c поддерживает такую же высокую скорость передачи данных, как линия Ethernet. При этом он сохраняет устойчивое соединение с роутером на большом расстоянии. Кроме того, ноутбук снабжён всем необходимым для подключения периферийного оборудования, включая порты USB и HDMI, а также передатчик Bluetooth.', 22500, 'uploads/item2.jpg', 'uploads/mini/item2.jpg', 1),
(10, 'Тест', 'тест', 11111, 'uploads/item3.jpg', 'uploads/mini/item3.jpg', 1),
